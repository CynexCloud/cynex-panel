> [!NOTE]
> Cynex 2.0.0 is stable and ready for production. If it breaks, you probably forgot to set `SESSION_SECRET` -_-
...
[![License](https://img.shields.io/github/license/CynexCloud/panel)](https://github.com/CynexCloud/panel/blob/main/LICENSE)
...
CynexPanel is the brain of the operation. It's a web-based control center for deploying, monitoring, and managing game servers across multiple machines. Think of it as the thing that yells at the daemon so you don't have to -_-
...
For full documentation, visit **[CynexCloud.xyz/docs/quick-start/](https://CynexCloud.xyz/docs/quick-start/)**.
...
```bash
sudo su
bash <(curl -s https://raw.githubusercontent.com/CynexCloud/panel/refs/heads/main/installer.sh)
```
...
```bash
systemctl start cynex-panel
systemctl stop cynex-panel
systemctl restart cynex-panel
journalctl -u cynex-panel -f
```
...
```bash
cd /var/www/
git clone https://github.com/CynexCloud/panel.git
cd panel
...
```bash
npm install -g pm2
pm2 start "pnpm run start" --name cynex-panel
pm2 save
pm2 startup
```
...
|----------|----------|-------------|
| `NAME` | No | Panel display name (default: Cynex) |
...
<a href="https://www.star-history.com/?repos=CynexCloud%2Fpanel&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/image?repos=CynexCloud/panel&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/image?repos=CynexCloud/panel&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/image?repos=CynexCloud/panel&type=date&legend=top-left" />
 </picture>
</a>
...
- Website: [CynexCloud.xyz](https://CynexCloud.xyz/)
- Docs: [CynexCloud.xyz/docs/quick-start](https://CynexCloud.xyz/docs/quick-start/)
- Discord: [discord.gg/ujXyxwwMHc](https://discord.gg/ujXyxwwMHc)
- GitHub: [github.com/CynexCloud/panel](https://github.com/CynexCloud/panel)
