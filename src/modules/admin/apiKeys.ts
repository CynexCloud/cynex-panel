...
registerPermission('cynex.admin.apikeys.view');
registerPermission('cynex.admin.apikeys.create');
registerPermission('cynex.admin.apikeys.delete');
registerPermission('cynex.admin.apikeys.edit');
registerPermission('cynex.admin.api.docs.view');
...
const coreModule: Module = {
  ...
  router: () => {
    ...
    router.get(
      '/admin/api/docs',
      isAuthenticated(true, 'cynex.admin.api.docs.view'),
              ...
              endpoints: [
                {
                  ...
                  permission: 'cynex.api.users.read',
                  responseExample: `{
  "data": [
    {
      "id": 1,
  ...
  "meta": { "total": 1, "per_page": 25, "current_page": 1, "last_page": 1 }
                ...
                },
                {
                  ...
                  permission: 'cynex.api.users.create',
                  requestExample: `{
  ...
  "data": {
    ...
    "description": "Administrator account"
                ...
                },
                {
                  ...
                  permission: 'cynex.api.users.update',
                  requestExample: `{
  ...
  "data": {
    ...
    "description": "Administrator account"
                ...
                },
                {
                  ...
                  permission: 'cynex.api.users.delete',
                  responseExample: `{
  "data": { "success": true }
}`
                }
              ...
              endpoints: [
                {
                  ...
                  permission: 'cynex.api.servers.read',
                  responseExample: `{
  "data": [
    {
      "id": 1,
  ...
  "meta": { "total": 1, "per_page": 25, "current_page": 1, "last_page": 1 }
                ...
                },
                {
                  ...
                  permission: 'cynex.api.servers.create',
                  requestExample: `{
  "name": "My Server",
  "description": "Optional description",
  "ownerId": 1,
  ...
  "data": {
    ...
    "node": { "id": 1, "name": "Node 1", "address": "127.0.0.1" }
                ...
                },
                {
                  ...
                  permission: 'cynex.api.servers.update',
                  requestExample: `{
  ...
  "data": {
    ...
    "Suspended": false
                ...
                },
                {
                  ...
                  permission: 'cynex.api.servers.delete',
                  responseExample: `{
  "data": { "success": true }
}`
                }
              ...
              endpoints: [
                {
                  ...
                  permission: 'cynex.api.nodes.read',
                  responseExample: `{
  "data": [
    {
      "id": 1,
  ...
  "meta": { "total": 1, "per_page": 25, "current_page": 1, "last_page": 1 }
                ...
                },
                {
                  ...
                  permission: 'cynex.api.nodes.create',
                  requestExample: `{
  "name": "Node 2",
    ...
    "servers": [
      {
        ...
        "Storage": 20480
                ...
                },
                {
                  ...
                  permission: 'cynex.api.nodes.update',
                  requestExample: `{
  "name": "Updated Node",
  "ram": 32768
}`,
  ...
  "data": {
    ...
    "createdAt": "2023-01-01T00:00:00.000Z"
                ...
                },
                {
                  ...
                  permission: 'cynex.api.nodes.delete',
                  responseExample: `{
  "data": { "success": true }
}`
                }
              ...
              endpoints: [
                {
                  ...
                  permission: 'cynex.api.settings.read',
                  responseExample: `{
  "data": {
    "id": 1,
    "title": "Cynex",
    "description": "Cynex is a free and open source project by CynexLabs",
    ...
    "updatedAt": "2023-01-01T00:00:00.000Z"
                ...
                },
                {
                  ...
                  permission: 'cynex.api.settings.update',
                  requestExample: `{
  "title": "My Panel",
  ...
  "data": {
    ...
    router.get(
      '/admin/apikeys',
      isAuthenticated(true, 'cynex.admin.apikeys.view'),
      async (req: Request, res: Response) => {
        try {
          const apiKeys = await prisma.apiKey.findMany({
            include: {
          ...
          const allPermissions = [
            { name: 'Servers - Read', value: 'cynex.api.servers.read' },
            { name: 'Servers - Create', value: 'cynex.api.servers.create' },
            { name: 'Servers - Update', value: 'cynex.api.servers.update' },
            { name: 'Servers - Delete', value: 'cynex.api.servers.delete' },
            { name: 'Users - Read', value: 'cynex.api.users.read' },
            { name: 'Users - Create', value: 'cynex.api.users.create' },
            { name: 'Users - Update', value: 'cynex.api.users.update' },
            { name: 'Users - Delete', value: 'cynex.api.users.delete' },
            { name: 'Nodes - Read', value: 'cynex.api.nodes.read' },
            { name: 'Nodes - Create', value: 'cynex.api.nodes.create' },
            { name: 'Nodes - Update', value: 'cynex.api.nodes.update' },
            { name: 'Nodes - Delete', value: 'cynex.api.nodes.delete' },
            { name: 'Settings - Read', value: 'cynex.api.settings.read' },
            { name: 'Settings - Update', value: 'cynex.api.settings.update' },
          ];
    ...
    router.post(
      ...
      isAuthenticated(true, 'cynex.admin.apikeys.create'),
      async (req: Request, res: Response) => {
        try {
    ...
    router.post(
      ...
      isAuthenticated(true, 'cynex.admin.apikeys.delete'),
      async (req: Request, res: Response) => {
        try {
    ...
    router.post(
      ...
      isAuthenticated(true, 'cynex.admin.apikeys.edit'),
      async (req: Request, res: Response) => {
        try {
          const id = getParamAsNumber(req.params.id);
