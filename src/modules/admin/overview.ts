...
registerPermission('cynex.admin.overview.main');
registerPermission('cynex.admin.overview.checkForUpdates');
registerPermission('cynex.admin.overview.performUpdate');
...
const adminModule: Module = {
  ...
  router: () => {
    ...
    router.get(
      '/admin/overview',
      isAuthenticated(true, 'cynex.admin.overview.main'),
    ...
    router.get(
      '/admin/check-update',
      isAuthenticated(true, 'cynex.admin.overview.checkForUpdates'),
    ...
    router.post(
      ...
      isAuthenticated(true, 'cynex.admin.overview.performUpdate'),
      async (_req: Request, res: Response) => {
        try {
