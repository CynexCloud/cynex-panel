...
const coreModule: Module = {
  ...
  router: () => {
      ...
      res.json({
        data: {
          ...
          endpoints: [
            ...
            { method: 'GET', path: '/api/v1/users', description: 'List users', permission: 'cynex.api.users.read' },
            { method: 'POST', path: '/api/v1/users', description: 'Create a user', permission: 'cynex.api.users.create' },
            { method: 'GET', path: '/api/v1/users/:id', description: 'Get a user', permission: 'cynex.api.users.read' },
            { method: 'PATCH', path: '/api/v1/users/:id', description: 'Update a user', permission: 'cynex.api.users.update' },
            { method: 'DELETE', path: '/api/v1/users/:id', description: 'Delete a user', permission: 'cynex.api.users.delete' },
            { method: 'GET', path: '/api/v1/servers', description: 'List servers', permission: 'cynex.api.servers.read' },
            { method: 'POST', path: '/api/v1/servers', description: 'Create a server', permission: 'cynex.api.servers.create' },
            { method: 'GET', path: '/api/v1/servers/:id', description: 'Get a server', permission: 'cynex.api.servers.read' },
            { method: 'PATCH', path: '/api/v1/servers/:id', description: 'Update a server', permission: 'cynex.api.servers.update' },
            { method: 'POST', path: '/api/v1/servers/:id/suspend', description: 'Suspend a server', permission: 'cynex.api.servers.update' },
            { method: 'POST', path: '/api/v1/servers/:id/unsuspend', description: 'Unsuspend a server', permission: 'cynex.api.servers.update' },
            { method: 'DELETE', path: '/api/v1/servers/:id', description: 'Delete a server', permission: 'cynex.api.servers.delete' },
            { method: 'GET', path: '/api/v1/nodes', description: 'List nodes', permission: 'cynex.api.nodes.read' },
            { method: 'POST', path: '/api/v1/nodes', description: 'Create a node', permission: 'cynex.api.nodes.create' },
            { method: 'GET', path: '/api/v1/nodes/:id', description: 'Get a node', permission: 'cynex.api.nodes.read' },
            { method: 'PATCH', path: '/api/v1/nodes/:id', description: 'Update a node', permission: 'cynex.api.nodes.update' },
            { method: 'DELETE', path: '/api/v1/nodes/:id', description: 'Delete a node', permission: 'cynex.api.nodes.delete' },
            { method: 'GET', path: '/api/v1/settings', description: 'Get settings', permission: 'cynex.api.settings.read' },
            { method: 'PATCH', path: '/api/v1/settings', description: 'Update settings', permission: 'cynex.api.settings.update' },
          ],
        },
      });
    });
    ...
    router.get(
      '/api/v1/users',
      apiValidator('cynex.api.users.read'),
    ...
    router.post(
      '/api/v1/users',
      apiValidator('cynex.api.users.create'),
      async (req: Request, res: Response) => {
        try {
    ...
    router.patch(
      '/api/v1/users/:id',
      apiValidator('cynex.api.users.update'),
      async (req: Request, res: Response) => {
        try {
          const userId = getParamAsNumber(req.params.id);
          const { email, username, password, isAdmin, description } = req.body;
    ...
    router.delete(
      '/api/v1/users/:id',
      apiValidator('cynex.api.users.delete'),
      async (req: Request, res: Response) => {
        try {
          const userId = getParamAsNumber(req.params.id);
    ...
    router.get(
      '/api/v1/servers',
      apiValidator('cynex.api.servers.read'),
      async (req: Request, res: Response) => {
        try {
          const page = Number(req.query.page) || 1;
          const perPage = Number(req.query.per_page) || 25;
    ...
    router.post(
      '/api/v1/servers',
      apiValidator('cynex.api.servers.create'),
      async (req: Request, res: Response) => {
        try {
    ...
    router.patch(
      '/api/v1/servers/:id',
      apiValidator('cynex.api.servers.update'),
      async (req: Request, res: Response) => {
        try {
    ...
    router.delete(
      '/api/v1/servers/:id',
      apiValidator('cynex.api.servers.delete'),
      async (req: Request, res: Response) => {
        try {
          const serverId = getParamAsString(req.params.id);
    ...
    router.get(
      '/api/v1/nodes',
      apiValidator('cynex.api.nodes.read'),
      async (req: Request, res: Response) => {
        try {
          const page = Number(req.query.page) || 1;
          const perPage = Number(req.query.per_page) || 25;
    ...
    router.post(
      '/api/v1/nodes',
      apiValidator('cynex.api.nodes.create'),
      async (req: Request, res: Response) => {
        try {
    ...
    router.patch(
      '/api/v1/nodes/:id',
      apiValidator('cynex.api.nodes.update'),
      async (req: Request, res: Response) => {
        try {
          const nodeId = getParamAsNumber(req.params.id);
          const { name, address, port, ram, cpu, disk, key, sftpPort } = req.body;
    ...
    router.delete(
      '/api/v1/nodes/:id',
      apiValidator('cynex.api.nodes.delete'),
      async (req: Request, res: Response) => {
        try {
          const nodeId = getParamAsNumber(req.params.id);
    ...
    router.get(
      '/api/v1/settings',
      apiValidator('cynex.api.settings.read'),
    ...
    router.patch(
      '/api/v1/settings',
      apiValidator('cynex.api.settings.update'),
      async (req: Request, res: Response) => {
        try {
