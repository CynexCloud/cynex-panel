...
The Modrinth Store is a panel addon that integrates the [Modrinth](https://modrinth.com) API into Cynex, allowing users to browse, search, and install mods, modpacks, plugins, shaders, resource packs, and datapacks directly from the panel UI.
