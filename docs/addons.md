# CynexPanel Addon System

This document is the primary reference for building addons for CynexPanel. It covers the v2 manifest format, the full Addon API surface, lifecycle hooks, permissions, settings, slots, commands, scheduled tasks, and the security model.
